...
I then used a 'vote' of the model results to and selected the most common (modal) prediction as the final predictions.  I then compared these with the actual classe outcomes in the validation data.
